...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
    AcsLogin *login = (AcsLogin *)[users objectAtIndex:indexPath.row];
    cell.textLabel.text = [NSString stringWithFormat:@"%@ - %@", login.siteName, login.userName];
...
{
    //write selected user and update CurrentIdentity
    ...
    identity.password = credentials.password;
